...
st.title('Palm leaf letter detection and recognisation')
...
def getlabel(img):
    ...
    img_array = timage.img_to_array(img)
...
def craft(tf1):
    ...
    for k, image_path in enumerate(image_list):
        ...
        final = Img.open(f1)
        st.image(final, caption="detected")
        ...
        st.image(final,caption="recognise")
    print("elapsed time : {}s".format(time.time() - t))


uploaded_file = st.file_uploader('Choose your image file', type=["pdf","png","jpg"])
